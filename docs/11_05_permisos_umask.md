...
!!! example "Ejercicio 4: Script de prueba"
    1. Crea el script de prueba del apartado anterior
    2. Dale permisos de ejecución
    3. Ejecútalo y analiza los resultados
    4. Comprueba que cada umask produce los permisos esperados
